...
{
    public delegate void kingBeingAttackedEventHandler(object sender, KingBeingAttackedEventArgs args);
    public delegate void UnitBeingAttackedEventHandler(object sender, UnitBeingAttackedEventArgs args);
    ...
    public static void Main()
    {
        ...
        while ((input = Console.ReadLine()) != "End")
        {
            ...
            else
            {
                ...
                king.UnitTakeAttack(soldierName);
            }
        }
    }
}